...
navigation task. The joint plan, including part of the data transfer process,
are managed by Roby.  This bi-robot setup has also been tested on real robots,
with an iRobot ATRV and a Yamaha RMAX helicopter.
