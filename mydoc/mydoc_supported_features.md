...
PDF output | No | If you absolutely must have PDF, you can generate PDFs through Prince XML, but the process was somewhat complicated, and in an effort to simplify the theme, I removed this component. 
