...
{% raw %}
```html
{{site.data.mydoc_urls.mydoc_getting_started.link}}
```
{% endraw %}
...
{% raw %}
```html
After downloading the theme, you can [get started in building the theme]({{site.data.mydoc_urls.mydoc_getting_started.url}}).
```
{% endraw %}
...
{% raw %}
```html
<p>After downloading the theme, you can <a href="{{site.data.mydoc_urls.mydoc_getting_started.url}}">get started in building the theme</a>.</p>
```
{% endraw %}
...
Another way to ensure you don't have any broken links in your output is to [generate a PDF]({{site.data.mydoc_urls.mydoc_generating_pdfs.url}}). When you generate a PDF, look for the following two problems in the output:
