...
permalink: /mydoc_configuration_settings/
---
...
More detail about generating PDFs is provided in {{site.data.mydoc_urls.mydoc_generating_pdfs.link}}, but the configuration settings used for the PDFs are described here.
