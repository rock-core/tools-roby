...
require 'roby/actions/models/action_coordination/task_from_as_plan'
require 'roby/actions/models/action_coordination'
require 'roby/actions/models/state_machine'
require 'roby/actions/script_instruction'
require 'roby/actions/models/script'
require 'roby/actions/models/fault_handler'
...
require 'roby/actions/script_base'
require 'roby/actions/script'
require 'roby/actions/fault_handling_task'
require 'roby/actions/fault_handler'
