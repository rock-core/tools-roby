...
module Roby::Log
	...
	def calling(context)
	    super if defined? super
	    Roby::Log.log(:generator_calling) { [Time.now, self, Log::Propagation.source_generators, context.to_s] }
	end
	...
	def emitting(context)
	    super if defined? super
	    Roby::Log.log(:generator_emitting) { [Time.now, self, Log::Propagation.source_generators, context.to_s] }
	end
