    ...
    module Interface
        module V2
            ...
            class Client
                ...
                #
                # In addition to the events generated by the remote Roby app, the client
                # emits the "cycle_end" event
                #
                # @return [(String,Array),nil] the event, or nil if there are none
                #   left
                def pop_log_event
