...
module Roby
    describe Plan do
        ...
        describe "#copy_marks!" do
            ...
            it "copies plan marks from one task to the other" do
                plan.add_permanent_task task_1
                plan.add_mission_task task_1

                plan.copy_marks!(from_task: task_1, to_task: task_2)
            ...
            it "does not unmark destination task" do
