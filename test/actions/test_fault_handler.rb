...
describe Roby::Actions::Models::FaultHandler do
    ...
    before do
        ...
        fault_response_table = Roby::Actions::FaultResponseTable.new_submodel
        @handler = Roby::Actions::FaultHandler.new_submodel(fault_response_table)
